...
const routes = [
  ...
  },
  {
    path: '/parser',
    name: 'parser',
    component: () => import('../views/Parser/ParserList.vue')
  },
  {
    path: '/artiste',
    name: 'artiste',
  ...
  },
  {
    path: '/typestand',
    name: 'typestand',
    component: () => import('../views/TypeStand/TypeStandListView.vue')
  },
  {
    path: '/typestand/add',
    name: 'typestand-add',
    component: () => import('../views/TypeStand/TypeStandAddView.vue')
  },
  {
    path: '/typestand/:id/edit',
    name: 'typestand-edit',
    component: () => import('../views/TypeStand/TypeStandEditView.vue')
  },
  {
    path: '/service',
    name: 'service',
